 ...
 <div class="left-sidenav">
            ...
            <div class="menu-content h-100" data-simplebar>
                <ul class="metismenu left-sidenav-menu">
                    ...
                    <li>
                        <a href="{{env('APP_URL')}}/"> <i data-feather="home" class="align-self-center menu-icon"></i><span>Dashboard</span></a>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="true">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{env('APP_URL')}}/cetak/penerima"><i data-feather="home" class="align-self-center menu-icon"></i>Cetak Penerima</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            <li class="nav-item"><a class="nav-link" href="{{env('APP_URL')}}/manager"><i data-feather="home" class="align-self-center menu-icon"></i>Tabel Penguji</a></li>
                        </ul>
                    </li>
